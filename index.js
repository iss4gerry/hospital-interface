...
switch (command) {
    ...
    case "addPatient":
        HospitalController.addPatient(argument[0], argument[1], argument[2], argument[3])
        break;

    case "updatePatient" :
        HospitalController.updatePatient(argument[0], argument[1], argument[2], argument[3])
        break;

    case "deletePatient" :
        HospitalController.deletePatient(argument[0], argument[1], argument[2], argument[3])
        break;
